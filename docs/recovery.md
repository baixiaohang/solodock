...
- Docker drift：用 exact project/service/full container ID 检查 unmanaged、stale 或 multiple candidate。先备份业务数据，再明确选择人工修复；禁止通配 cleanup、`docker compose down -v`、`docker volume rm`。
